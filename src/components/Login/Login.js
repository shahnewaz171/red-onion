                    ...
                    {returningUser ? <form onSubmit={handleSubmit(onSubmit)} className="py-5">
                        ...
                        <div className="text-center pt-2">
                            <label style={{color: '#000'}}>
                                ...
                                <span onClick={() => setReturningUser(false)} className="text-danger ms-1 sign-bold">Create an account</span>
                            </label>
                        </div>
                    </form>
                    :
                    <form onSubmit={handleSubmit(onSubmit)} className="py-5">
                        ...
                        <div className="text-center">
                            <label style={{color: '#000'}}>
                                ...
                                <span onClick={() => setReturningUser(true)} className="text-danger ms-1 sign-bold">Login</span>
                            </label>
                        </div>
                    </form>
                    }
